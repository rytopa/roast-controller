...
- **Notes & stars** — a notes box in the Data panel follows the current roast (the one roasting, just dropped, or loaded from the list) and saves as you type; the ★ button marks an excellent roast so it stands out in the saved-roast list.
