...
- **Manual mode** — choose *Manual* under *At bean drop* in the between-batch panel: the cycle cools, charges and lights up as usual, then at Charge the app runs the soak (if on), sets your opening heater and fan with the PID off, and hands the roast to you on the Controls rail. As in every mode, if DE has not been tagged by the time the bean temperature reaches 180 °C, it is tagged automatically at the moment BT crossed the DE temperature.
