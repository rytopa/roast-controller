...
- **Live guidance** — a live Dry/Maillard/Dev phase bar, a dotted **BT projection** (60 s look-ahead at current RoR), an **FC countdown**, and automatic **RoR crash / flick warnings**. The RoR trace has an adjustable **window** (responsiveness) and **smoothing** (a moving average that cleans the jaggedness from the roaster's ~1 °C telemetry steps).
