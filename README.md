...
- **Control rail** — a stock-app style column beside the chart: Target temp and PID tiles, Heater −/+ and Fan −/+ steppers in 1 % steps (heater ± takes manual control: PID off, running profile stopped), a green event-tagging button that advances DE → FC, and a red Stop / Drop.
