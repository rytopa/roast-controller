...
- **Safe endings** — when a running profile reaches its last point the heater switches off automatically (with an alert); pressing **Drop** turns the heater off and sets the fan to 100 % for cooling.
