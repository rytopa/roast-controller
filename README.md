...
- **Notes & stars** — a notes box in the Data panel follows the roast selected in the saved-roast list (or holds a draft for the roast in progress) and saves as you type; the ★ button marks an excellent roast so it stands out in the saved-roast list.
